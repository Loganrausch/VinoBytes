...
struct WineGlossaryData {
    static let terms: [GlossaryEntry] = [
        ...
        GlossaryEntry(term: "Aroma",
                      definition: "Refers to the smells that come from the grapes and the fermentation process. These are primarily derived from the grape variety and are distinct from scents that develop in wine due to aging.",
                      additionalInfo: "In young wines, aromas are typically fruity or floral, reflecting the characteristics of the grape varietal. As wine ages, these primary aromas can evolve, adding complexity that includes earthy or spicy notes."),
        ...
        GlossaryEntry(term: "Bouquet",
                      definition: "Refers to the complex aromas that develop in wine after it has aged. These aromas are influenced by winemaking processes and the aging of the wine in barrels and bottles.",
                      additionalInfo: "Bouquet differs from aroma, which is associated with the primary scents of young wines derived from the grape variety and fermentation. Bouquet includes secondary aromas from fermentation and oak aging (like vanilla, smoke, and butter) and tertiary aromas that develop with bottle aging, such as dried fruit, leather, tobacco, and earthy notes."),
        ...
        GlossaryEntry(term: "Claret",
                      ...
                      additionalInfo: "Traditionally, Claret is a blend of several grape varieties, primarily Cabernet Sauvignon, Merlot, Cabernet Franc, Petit Verdot, and Malbec. The term originated from the French word 'clairet,' which referred to the pale style of red Bordeaux wines in the Middle Ages. Today, it is commonly used in the UK to refer to all red wines from the Bordeaux region."),
        GlossaryEntry(term: "Clos",
                      definition: "A French term for a vineyard that is enclosed by walls or hedges.",
                      additionalInfo: "The term 'Clos' is most commonly used in Burgundy but can also be found in other French wine regions. Originally, these walls were built to protect the vineyard from animals and theft. Today, the term often signifies a prestigious vineyard with historical significance."),
        ...
        GlossaryEntry(term: "Dry",
                      ...
                      additionalInfo: "The dryness is determined by the level of residual sugar left after fermentation, with less than 1% residual sugar typically considered dry."),
        GlossaryEntry(term: "Enology",
                      definition: "The science and study of wine and winemaking, covering all aspects from grape growing to bottling.",
                      additionalInfo: "Enology (or oenology) includes vineyard management, fermentation processes, aging, and analysis of wine. It is a comprehensive field that integrates both science and art to produce wine."),
        ...
        GlossaryEntry(term: "Fortified Wine",
                      ...
                      additionalInfo: "Examples include Port, Sherry, and Madeira. Fortification can be done during or after fermentation, affecting the wine's sweetness, flavor, and style."),
        ...
        GlossaryEntry(term: "Late Harvest",
                      ...
                      additionalInfo: "These wines are often sweet due to the higher sugar content in the grapes. Late harvest wines can range from off-dry to lusciously sweet and are often made from varieties such as Riesling, Chenin Blanc, and Gewürztraminer."),
        ...
        GlossaryEntry(term: "Malolactic Fermentation",
                      ...
                      additionalInfo: "This process can soften the wine, reduce acidity, and add complexity with flavors such as butter or cream, particularly in white wines like Chardonnay. Malolactic fermentation is also common in many red wines to enhance mouthfeel and stability."),
        GlossaryEntry(term: "Meritage",
                      definition: "A term used in the United States for Bordeaux-style wines, both red and white.",
                      additionalInfo: "Meritage wines must be made from a blend of specific grape varieties traditionally associated with Bordeaux, such as Cabernet Sauvignon, Merlot, Cabernet Franc, Petit Verdot, and Malbec for red wines, and Sauvignon Blanc, Sémillon, and Muscadelle for white wines. The term 'Meritage' is a trademark that requires producers to follow specific blending rules."),
        ...
        GlossaryEntry(term: "Négociant",
                      ...
                      additionalInfo: "Négociants play a significant role in wine regions such as Burgundy and the Rhône Valley, where they can blend wines from multiple producers to create consistent products. Some négociants also own vineyards and produce estate-bottled wines."),
        GlossaryEntry(term: "Oaked",
                      ...
                      additionalInfo: "Oaked wines often exhibit flavors and aromas such as vanilla, spice, toast, and sometimes coconut or smoke, depending on the type of oak used and the length of aging. Oak aging can also add structure and texture to the wine, contributing to its mouthfeel and aging potential."),
        ...
        GlossaryEntry(term: "Phylloxera",
                      definition: "A tiny, sap-sucking insect that attacks the roots and sometimes the leaves of grapevines.",
        ...
        GlossaryEntry(term: "Pomace",
                      definition: "The solid remains of grapes after pressing, including skins, pulp, seeds, and sometimes stems.",
                      additionalInfo: "Pomace can be repurposed for making distilled spirits such as grappa, or used as compost and animal feed. It is also sometimes used for extracting additional juice or in cosmetic and food industries for its antioxidant properties."),
        ...
        GlossaryEntry(term: "Sediment",
                      definition: "Solid particles that settle at the bottom of a wine bottle over time.",
        ...
        GlossaryEntry(term: "Sommelier",
                      definition: "A wine steward responsible for wine service, selection, and pairing in a restaurant.",
                      additionalInfo: "Sommeliers are trained and knowledgeable in all aspects of wine, including tasting, wine regions, and grape varieties. They often assist customers in selecting wines that complement their meal and enhance the dining experience. Certification programs, such as those offered by the Court of Master Sommeliers and the Wine & Spirit Education Trust (WSET), provide formal training and recognition for sommeliers."),
        GlossaryEntry(term: "Sur Lie Aging",
                      ...
                      additionalInfo: "This technique is commonly used in the production of certain white wines, such as Muscadet, Champagne, and some Chardonnays. Sur lie aging can impart flavors of bread, nuts, and creaminess to the wine, contributing to a fuller mouthfeel and greater complexity."),
        ...
        GlossaryEntry(term: "Tannin",
                      ...
                      additionalInfo: "Tannins are most prominent in red wines, providing a drying sensation on the palate and contributing to the wine's complexity and ability to age. They also act as antioxidants, which help preserve the wine over time."),
        ...
        GlossaryEntry(term: "Viticulture",
                      ...
                      additionalInfo: "Viticulture focuses on the growing and harvesting of grapes, taking into account factors like soil quality, climate, vineyard management, and disease control. It is a key component of winemaking, as the quality of the grapes greatly influences the quality of the wine."),
        ...
        GlossaryEntry(term: "Cultivar",
                      definition: "A plant variety that has been produced in cultivation through selective breeding.",
        ...
        GlossaryEntry(term: "Herbaceous",
                      ...
                      additionalInfo: "Herbaceous notes are often associated with certain grape varieties, such as Sauvignon Blanc, Cabernet Franc, and some cool-climate expressions of Cabernet Sauvignon. These characteristics can contribute freshness and complexity to a wine."),
        ...
        GlossaryEntry(term: "Zesty",
                      definition: "Describes wines with lively, vibrant, and sharp flavors, often attributed to high acidity.",
                      additionalInfo: "The term 'zesty' is commonly used to describe certain white wines, such as Sauvignon Blanc, Riesling, and Albariño, which are known for their bright acidity and fresh, citrusy flavors."),
        ...
        GlossaryEntry(term: "Brut",
                      ...
                      additionalInfo: "Brut wines typically contain less than 12 grams of residual sugar per liter. The term indicates a dry style, making Brut Champagne and sparkling wines crisp and refreshing, suitable for pairing with a wide range of foods."),
        ...
        GlossaryEntry(term: "Cuvée",
                      definition: "A term used to denote a specific batch or blend of wine.",
                      additionalInfo: "In Champagne and sparkling wine production, 'cuvée' often refers to the blend of base wines used to create the final sparkling wine. It can also indicate a special or premium selection in other types of wine production."),
        GlossaryEntry(term: "Demeter",
                      definition: "An organization that certifies biodynamic farms and products worldwide.",
                      additionalInfo: "The Demeter certification indicates adherence to biodynamic principles, including organic farming practices, crop rotation, composting, and the use of biodynamic preparations. Demeter's standards are among the strictest in organic and biodynamic farming, ensuring ecological sustainability and environmental stewardship."),
        ...
        GlossaryEntry(term: "Cross-Vintage Blending",
                      definition: "The process of blending wines from different vintages to achieve a consistent style and quality.",
                      additionalInfo: "This practice is commonly used in Champagne production to maintain a consistent house style across non-vintage sparkling wines. Cross-vintage blending allows winemakers to balance the unique characteristics of each vintage and create a harmonious final product."),
        ...
        GlossaryEntry(term: "Field Blend",
                      ...
                      additionalInfo: "Field blending often results in a unique and complex wine that expresses the terroir in a distinctive way. This traditional practice is still used in some regions, where the mixed planting of grape varieties can enhance the wine's balance and complexity."),
        ...
        GlossaryEntry(term: "Aging",
                      ...
                      additionalInfo: "Aging can significantly affect a wine's characteristics, including softening tannins, enhancing complexity, and integrating flavors. The choice of aging vessel—such as oak barrels, stainless steel tanks, or bottles—impacts the wine's final profile, with different methods contributing unique attributes."),
        GlossaryEntry(term: "Amelioration",
                      definition: "The addition of water and sugar to grape juice before fermentation to balance acidity and increase alcohol content.",
        ...
        GlossaryEntry(term: "Barrel Fermentation",
                      ...
                      additionalInfo: "Barrel fermentation imparts additional flavors and textures to the wine, such as vanilla, toast, and spice notes from the oak. It also influences the wine’s mouthfeel, adding complexity and richness, particularly in white wines like Chardonnay and some red wines."),
        GlossaryEntry(term: "Barrel Toasting",
                      ...
                      additionalInfo: "Barrel toasting can range from light to heavy, with each level imparting different flavors such as vanilla, caramel, spice, or smoke. The toasting process also affects the tannins and structure of the wine, contributing to its overall complexity and depth."),
        ...
        GlossaryEntry(term: "Bordeaux Mixture",
                      ...
                      additionalInfo: "Bordeaux Mixture is widely used in organic and conventional viticulture to prevent and manage mildew and other fungal infections. It is named after the Bordeaux region of France, where it was first developed in the late 19th century."),
        ...
        GlossaryEntry(term: "Carbonic Acid",
                      definition: "A weak acid formed in wine when carbon dioxide (CO2) dissolves in water, influencing the wine's pH and acidity.",
                      additionalInfo: "Carbonic acid plays a role in the perceived freshness and crispness of wine. It is particularly relevant in sparkling wines and wines produced using carbonic maceration, where CO2 levels are higher. The presence of carbonic acid can contribute to the overall balance of acidity in wine."),
        ...
        GlossaryEntry(term: "Cuverie",
                      definition: "A French term for a winery or wine production facility that includes fermentation tanks and other winemaking equipment.",
                      additionalInfo: "The cuverie is the heart of the winemaking process, housing all the necessary equipment for fermentation, maceration, and aging. It is designed to provide optimal conditions for winemaking and may include stainless steel, concrete, or oak vessels depending on the desired style of wine."),
        ...
        GlossaryEntry(term: "Earthy",
                      definition: "A tasting note indicating flavors or aromas reminiscent of soil, earth, or minerals.",
        ...
        GlossaryEntry(term: "Lees Contact",
                      definition: "The practice of aging wine on its lees, the dead yeast cells and other particles that settle after fermentation, to enhance flavors and textures.",
        ...
        GlossaryEntry(term: "Lysozyme",
                      definition: "An enzyme used in winemaking to control lactic acid bacteria and prevent spoilage.",
                      additionalInfo: "Lysozyme is naturally occurring in egg whites and is used to inhibit lactic acid bacteria without affecting yeast. It helps maintain wine stability and prevent undesirable malolactic fermentation, particularly in white and sparkling wines where preserving fresh, fruity characteristics is important."),
        ...
        GlossaryEntry(term: "Sec",
                      definition: "A French term meaning 'dry', often used to describe a style of Champagne or sparkling wine with a moderate level of sweetness.",
        ...
        GlossaryEntry(term: "Semi-Carbonic Maceration",
                      definition: "A winemaking technique where whole, uncrushed grapes are placed in a tank filled with carbon dioxide, allowing fermentation to begin within the grapes themselves without added CO2.",
                      additionalInfo: "This method, often associated with Beaujolais wines, produces fruity, low-tannin wines with a distinctive fresh and vibrant character. As the weight of the grapes causes the berries at the bottom of the tank to crush, traditional yeast fermentation also takes place, adding complexity to the final wine."),
        ...
        GlossaryEntry(term: "Melchior",
                      ...
                      additionalInfo: "Named after one of the Three Wise Men, the Melchior bottle is primarily used for large-format bottlings of Champagne and other sparkling wines. Its large size makes it suitable for special occasions and extended aging, as the greater volume allows for slower, more gradual development of flavors."),
        GlossaryEntry(term: "Solomon",
                      definition: "A wine bottle with a capacity of 20 liters, equivalent to 26 standard 750 ml bottles.",
        ...
        GlossaryEntry(term: "Blending",
                      ...
                      additionalInfo: "Blending is a common practice in winemaking to enhance complexity, balance, and consistency. It allows winemakers to adjust flavors, tannins, acidity, and other components to achieve a harmonious final wine. Blending can involve different grape varieties, vineyard plots, vintages, or even different winemaking techniques."),
        ...
        GlossaryEntry(term: "Carbonation",
                      definition: "The process of adding carbon dioxide (CO2) to wine to create bubbles, resulting in sparkling wine.",
                      additionalInfo: "Carbonation can occur naturally during fermentation or be artificially introduced. Natural carbonation happens when CO2 produced by fermentation is trapped in the wine, such as in the traditional method used for Champagne. Artificial carbonation involves injecting CO2 into still wine, similar to how soda is carbonated, and is often used for lower-cost sparkling wines."),
        ...
        GlossaryEntry(term: "Diurnal Range",
                      ...
                      additionalInfo: "A wider diurnal range, with warm days and cool nights, helps preserve acidity and enhance flavor complexity in grapes. This temperature variation allows for the development of sugars during the day while preserving acidity and slowing down ripening at night, contributing to a balanced and complex wine profile. Regions with significant diurnal ranges, such as those at higher altitudes, are often known for producing high-quality wines with excellent structure and aging potential."),
        ...
        GlossaryEntry(term: "Lutte Raisonnée",
                      definition: "A French term meaning 'reasoned struggle,' referring to a pragmatic approach to vineyard management that minimizes chemical use while allowing for their use when absolutely necessary.",
        ...
        GlossaryEntry(term: "Swirling",
                      ...
                      additionalInfo: "Swirling helps to aerate the wine, enhancing the release of volatile aromatic compounds, which improves the sensory experience. It allows for a more intense evaluation of the wine's bouquet, revealing its complexity and the subtle nuances of its aromas."),
        ...
        GlossaryEntry(term: "Maturing",
                      ...
                      additionalInfo: "Maturing can enhance the complexity and depth of flavors in a wine, softening tannins, and integrating the wine's various components into a harmonious whole. The process can vary significantly depending on the type of wine, storage conditions, and desired style, with some wines improving over decades while others are best consumed young."),
        GlossaryEntry(term: "Alcohol Content",
                      definition: "The percentage of alcohol by volume (ABV) in wine, typically ranging from 8% to 15%.",
        ...
        GlossaryEntry(term: "Weight",
                      ...
                      additionalInfo: "Weight in wine is influenced by factors such as alcohol content, sugar levels, tannin concentration, and the wine's extract. Wines can range from light-bodied (like Pinot Grigio or Beaujolais) to full-bodied (like Cabernet Sauvignon or Chardonnay), with the weight contributing significantly to the wine's mouthfeel and overall impression on the palate."),
        ...
        GlossaryEntry(term: "Doux",
                      definition: "A French term meaning 'sweet', used to describe wines with a high sugar content.",
                      additionalInfo: "Doux wines are often dessert wines and can be very rich and luscious, with residual sugar levels typically above 50 grams per liter. Common examples of doux wines include certain styles of Champagne, Sauternes, and Tokaji. These wines are often enjoyed as a dessert accompaniment or on their own as a sweet treat."),
