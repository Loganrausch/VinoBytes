...
struct WineGlossaryData {
    static let terms: [GlossaryEntry] = [
        ...
        GlossaryEntry(term: "Biodynamic Farming", definition: "An ecological and sustainable approach to farming based on the ideas of Rudolf Steiner.", additionalInfo: "Involves using natural preparations and following lunar cycles."),
        ...
        GlossaryEntry(term: "TCA (Trichloroanisole)", definition: "A chemical compound responsible for cork taint in wine.", additionalInfo: "Gives the wine a musty, moldy aroma."),
        ...
        GlossaryEntry(term: "Wild Fermentation", definition: "Fermentation using naturally occurring yeast on the grapes or in the winery.", additionalInfo: "Can produce unique and complex flavors."),
        GlossaryEntry(term: "Zinfandel", definition: "A red grape variety known for producing bold, fruity wines.", additionalInfo: "Widely grown in California."),
        ...
        GlossaryEntry(term: "Brettanomyces", definition: "A type of yeast that can cause undesirable flavors in wine, often described as barnyard or medicinal.", additionalInfo: "Commonly referred to as 'Brett'."),
        ...
        GlossaryEntry(term: "Réserve", definition: "A term indicating a wine of higher quality or longer aging.", additionalInfo: "Usage varies by country and region."),
        ...
        GlossaryEntry(term: "Cork Taint", definition: "A musty, moldy aroma and flavor caused by TCA contamination in wine.", additionalInfo: "Affects the quality and enjoyment of the wine."),
        ...
        GlossaryEntry(term: "Palletization", definition: "The process of storing and transporting wine bottles on pallets.", additionalInfo: "Improves efficiency and reduces handling."),
        GlossaryEntry(term: "Peachy", definition: "A tasting note indicating flavors or aromas reminiscent of peaches.", additionalInfo: "Often found in certain white wines."),
        ...
        GlossaryEntry(term: "Riesling", definition: "A white grape variety known for its aromatic qualities and high acidity.", additionalInfo: "Can produce wines ranging from dry to sweet."),
        ...
        GlossaryEntry(term: "Table Wine", definition: "A term for wine that is not sparkling or fortified.", additionalInfo: "Typically refers to everyday drinking wines."),
        GlossaryEntry(term: "T-bud Grafting", definition: "A method of grafting a bud from a scion onto a rootstock.", additionalInfo: "Used to propagate new vines."),
        ...
        GlossaryEntry(term: "Claret", definition: "A British term for red Bordeaux wine.", additionalInfo: "Claret is traditionally a blend of several grape varieties."),
        ...
        GlossaryEntry(term: "Glycerol", definition: "A byproduct of fermentation that adds sweetness and body to wine.", additionalInfo: "Glycerol contributes to the wine's mouthfeel."),
        GlossaryEntry(term: "Microclimate", definition: "The climate of a small, specific area within a vineyard.", additionalInfo: "Microclimate can significantly affect the quality of grapes."),
        GlossaryEntry(term: "Négociant", definition: "A wine merchant who buys grapes, juice, or finished wine from growers and winemakers.", additionalInfo: "Négociants then bottle and sell the wine under their own label."),
        GlossaryEntry(term: "Oxidative", definition: "A winemaking style or condition where the wine has been exposed to oxygen, resulting in certain flavor characteristics.", additionalInfo: "Oxidative winemaking can produce unique and complex wines."),
        ...
        GlossaryEntry(term: "Siliceous Soil", definition: "Soil that contains a high proportion of silica, which can influence the minerality and flavor profile of wine.", additionalInfo: "Siliceous soils are often found in regions with volcanic activity."),
