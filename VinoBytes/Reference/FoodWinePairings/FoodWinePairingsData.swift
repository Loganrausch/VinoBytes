...
let foodWinePairingsData = [
    FoodWinePairing(food: "Steak", grapes: [
        GrapeDetail(
            ...
            GrapeDetail(
                name: "Merlot (Red)",
                description: "Softer than Cabernet Sauvignon, a robust Merlot can also pair nicely with steak, especially if you prefer a wine that’s a bit less tannic.",
                servingTemperature: "Serve at 15-17°C (59-63°F)",
                glassType: "Use a medium-sized glass to focus the fruit aromas.",
                decantingRecommendation: "Short decanting can help to soften tannins."
            ),
            GrapeDetail(
                ...
                decantingRecommendation: "Decant older vintages to clarify."
            ),
            GrapeDetail(
                name: "Zinfandel (Red)",
    ...
    FoodWinePairing(food: "Chicken", grapes: [
        ...
        GrapeDetail(
            name: "Grenache (Red)",
            description: "Works well with both roasted and spiced chicken dishes due to its fruity and spicy profile.",
            servingTemperature: "Serve at 15-18°C (59-64°F)",
            glassType: "Use a medium-bodied red wine glass to balance fruit and spice notes.",
        ...
        GrapeDetail(
            ...
            decantingRecommendation: "No decanting required; serve immediately after opening to maintain effervescence."
        )
    ...
    FoodWinePairing(
        ...
        grapes: [
            ...
            GrapeDetail(
                name: "Barbera (Red)",
                description: "Barbera's high acidity makes it a great choice for cutting through creamy pasta dishes, providing a refreshing counterpoint to dishes like mushroom cream sauces.",
                servingTemperature: "Serve at 16-18°C (60-65°F)",
                glassType: "A medium-bodied red wine glass to highlight its fruit-forward profile.",
                decantingRecommendation: "Decanting is optional but can be done for 20 minutes to open up the flavors."
            )
    ...
    FoodWinePairing(
        ...
        grapes: [
            ...
            GrapeDetail(
                name: "Chablis (White)",
                description: "Chablis, known for its minerality and high acidity, is excellent with sushi, providing a flinty contrast to the oceanic flavors of sushi and enhancing the overall umami experience.",
                servingTemperature: "Serve at 10-12°C (50-54°F)",
